            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="right-image">
                        <img src="assets_1/images/feature-image.jpg" alt="">
                    </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="team-member">
                        <div class="thumb-container">
                            <img src="assets_1/images/team_01.jpg" alt="">
                ...
                <div class="col-md-4">
                    <div class="team-member">
                        <div class="thumb-container">
                            <img src="assets_1/images/team_02.jpg" alt="">
                            <div class="hover-effect">
                                <div class="hover-content">
                                    <ul class="social-icons">
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-md-4">
                    <div class="team-member">
                        <div class="thumb-container">
                            <img src="assets_1/images/team_03.jpg" alt="">
                            <div class="hover-effect">
                                <div class="hover-content">
                                    <ul class="social-icons">
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-md-4">
                    <div class="team-member">
                        <div class="thumb-container">
                            <img src="assets_1/images/team_04.jpg" alt="">
                            <div class="hover-effect">
                                <div class="hover-content">
                                    <ul class="social-icons">
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-md-4">
                    <div class="team-member">
                        <div class="thumb-container">
                            <img src="assets_1/images/team_05.jpg" alt="">
                            <div class="hover-effect">
                                <div class="hover-content">
                                    <ul class="social-icons">
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-md-4">
                    <div class="team-member">
                        <div class="thumb-container">
                            <img src="assets_1/images/team_06.jpg" alt="">
                            <div class="hover-effect">
                                <div class="hover-content">
                                    <ul class="social-icons">
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-md-12">
                    <div class="owl-clients owl-carousel">
                        <div class="client-item">
                            <img src="assets_1/images/client-01.png" alt="1">
                        </div>

                        <div class="client-item">
                            <img src="assets_1/images/client-01.png" alt="2">
                        </div>

                        <div class="client-item">
                            <img src="assets_1/images/client-01.png" alt="3">
                        </div>

                        <div class="client-item">
                            <img src="assets_1/images/client-01.png" alt="4">
                        </div>

                        <div class="client-item">
                            <img src="assets_1/images/client-01.png" alt="5">
                        </div>

                        <div class="client-item">
                            <img src="assets_1/images/client-01.png" alt="6">
                        </div>
                    </div>
                </div>
            </div>
